module github.com/asabya/go-storacha-upload-client-kit
...
require (
	...
	github.com/storacha/guppy v0.0.0-20250101000000-000000000000
...
replace github.com/storacha/guppy => ../../storacha/guppy
